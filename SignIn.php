...
<div class="card">
    ...
    <form class="form" method="post">
        ...
        <input
            ...
            name="password"
            id="password-input" />
        <button class="submit" name="signin" type="submit">Submit</button>
    </form>
    ...
    <label for="blind-input" class="avatar">
        <svg
            ...
            <g fill="#89664c">
                ...
                <path
                    d="m55.3 27.6c0-9.7-10.4-17.6-23.3-17.6s-23.3 7.9-23.3 17.6c0 2.3.6 4.4 1.6 6.4-1 2-1.6 4.2-1.6 6.4 0 9.7 10.4 17.6 23.3 17.6s23.3-7.9 23.3-17.6c0-2.3-.6-4.4-1.6-6.4 1-2 1.6-4.2 1.6-6.4"></path>
            </g>
            <path
