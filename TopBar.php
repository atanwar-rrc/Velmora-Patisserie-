...
<head>
    ...
    <link href="assets/css/header-enhancements.css" rel="stylesheet">
            ...
            <nav id="navmenu" class="navmenu d-flex justify-content-center flex-grow-1">
                ...
                <ul>
                    ...
                    <?php if ((isset($_SESSION['user_type']) && $_SESSION['user_type'] != "admin") || !isset($_SESSION['user_type'])) { ?>
                        ...
                        <li><a href="Testimonials.php" class="<?php echo ($current_page == 'Testimonials.php') ? 'active' : ''; ?>">Testimonials</a></li>
                        <?php if (isset($_SESSION['user_mail'])): ?>
                            <li><a href="Wishlist.php" class="<?php echo ($current_page == 'Wishlist.php') ? 'active' : ''; ?>"><i class="bi bi-heart-fill text-danger"></i> Wishlist</a></li>
                            <li><a href="Cart.php" class="<?php echo ($current_page == 'Cart.php') ? 'active' : ''; ?>"><i class="bi bi-cart3"></i> Cart</a></li>
                        <?php endif; ?>
                    <?php } else { ?>
                        <li><a href="AdminCategory.php" class="<?php echo ($current_page == 'AdminCategory.php') ? 'active' : ''; ?>">Categories</a></li>
                        <li><a href="AdminProduct.php" class="<?php echo (strpos($current_page, 'AdminProduct') !== false || strpos($current_page, 'AdminAddProduct') !== false || strpos($current_page, 'AdminUpdateProduct') !== false) ? 'active' : ''; ?>">Products</a></li>
                        <li><a href="AdminUser.php" class="<?php echo (strpos($current_page, 'AdminUser') !== false || strpos($current_page, 'AdminAddUser') !== false || strpos($current_page, 'AdminUpdateUser') !== false) ? 'active' : ''; ?>">Users</a></li>
                    <?php } ?>
                </ul>
